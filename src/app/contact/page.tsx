...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      titleEn: 'Address',
      titleKu: 'ناونیشان',
      valueAr: settings?.address?.ar || 'شارع التل، الدركزلية، حي الجزائر، الموصل، نينوى، العراق',
      valueEn: settings?.address?.en || 'Al-Tal Street, Al-Darkazliya, Al-Jazaer District, Mosul, Nineveh, Iraq',
      valueKu: (settings?.address as any)?.ku || settings?.address?.en || 'شەقامی تەل، دەرکەزلیە، گەڕەکی جەزائیر، موسڵ، نەینەوا، عێراق',
